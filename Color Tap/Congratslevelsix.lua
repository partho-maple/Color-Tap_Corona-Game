...
function new()
	...
	local txt = display.newText("Level Six", 63,90,font,40)
	txt:setTextColor(255,255,255)
	localGroup:insert(txt)
	
	local font = "Showcard Gothic"  
	local txt = display.newText("Tap Orange", 60,140,font,35)
	txt:setTextColor(255,165,0)
	localGroup:insert(txt)
