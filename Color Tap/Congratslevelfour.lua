...
function new()
	...
	local txt = display.newText("Level Four", 40,90,font,40)
	txt:setTextColor(255,255,255)
	localGroup:insert(txt)
	
	local font = "Showcard Gothic"  
	local txt = display.newText("Tap Pink", 76,140,font,35)
	txt:setTextColor(255,20,147)
	localGroup:insert(txt)
